...
public class ProjectController {
    ...
    // 프로젝트 생성 (AI가 로그 분석 결과 기반으로 자동 생성 — 로그인 구현 전 임시로 memberId 1L 고정)
    ...
    // 내 프로젝트 목록 조회 (프로젝트 메인 페이지 캐러셀용 — 로그인 구현 전 임시로 memberId 1L 고정)
    ...
    // 프로젝트 단건 조회 (상세 페이지 진입 시 — 로그인 구현 전 임시로 memberId 1L 고정)
    ...
    // 프로젝트 삭제 (상세 페이지에서 삭제 버튼 클릭 시 — 로그인 구현 전 임시로 memberId 1L 고정)
